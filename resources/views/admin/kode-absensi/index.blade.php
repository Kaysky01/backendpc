                    ...
                    <div class="rounded-2xl border border-gray-200 bg-slate-50 p-5">
                        <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                            ...
                            <form method="POST" action="{{ route('admin.kode-absensi.store', $item) }}">
                                @csrf
                                <button type="submit" class="btn-primary">Generate 6 Karakter</button>
                            </form>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="overflow-x-auto">
                <table class="table-base">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-slate-500">Belum ada kode absensi yang sesuai filter.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
